...
from apps.broker.tbank.adapter import TBankGrpcAdapter, quotation_to_decimal  # noqa: E402
...
class TestTBankManual(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_03_stream_reconnect_logic(self, mock_channel, mock_instr_stub, mock_stream_stub):
        ...
        mock_stream_service.MarketDataStream.side_effect = [MockStream("error"), MockStream("data")]
