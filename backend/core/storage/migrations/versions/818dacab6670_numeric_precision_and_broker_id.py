...
def upgrade() -> None:
    ...
    op.alter_column('positions', 'qty',
               existing_type=sa.DOUBLE_PRECISION(precision=53),
               type_=sa.Numeric(precision=18, scale=9),
               existing_nullable=True)
    op.alter_column('positions', 'avg_price',
               existing_type=sa.DOUBLE_PRECISION(precision=53),
               type_=sa.Numeric(precision=18, scale=9),
               existing_nullable=True)
    op.alter_column('positions', 'sl',
               existing_type=sa.DOUBLE_PRECISION(precision=53),
               type_=sa.Numeric(precision=18, scale=9),
               existing_nullable=True)
    op.alter_column('positions', 'tp',
               existing_type=sa.DOUBLE_PRECISION(precision=53),
               type_=sa.Numeric(precision=18, scale=9),
               existing_nullable=True)
    ...
    op.alter_column('positions', 'realized_pnl',
               ...
               type_=sa.Numeric(precision=18, scale=9),
               existing_nullable=True)
    op.alter_column('settings', 'risk_per_trade_pct',
               existing_type=sa.DOUBLE_PRECISION(precision=53),
               type_=sa.Numeric(precision=5, scale=2),
               existing_nullable=True)
    op.alter_column('settings', 'daily_loss_limit_pct',
               existing_type=sa.DOUBLE_PRECISION(precision=53),
               type_=sa.Numeric(precision=5, scale=2),
               existing_nullable=True)
    op.alter_column('settings', 'rr_target',
               existing_type=sa.DOUBLE_PRECISION(precision=53),
               type_=sa.Numeric(precision=5, scale=2),
               existing_nullable=True)
    op.add_column('signals', sa.Column('broker_id', sa.String(), nullable=True))
    op.alter_column('signals', 'entry',
               existing_type=sa.DOUBLE_PRECISION(precision=53),
               type_=sa.Numeric(precision=18, scale=9),
               existing_nullable=False)
    op.alter_column('signals', 'sl',
               ...
               type_=sa.Numeric(precision=18, scale=9),
               existing_nullable=False)
    op.alter_column('signals', 'tp',
               existing_type=sa.DOUBLE_PRECISION(precision=53),
               type_=sa.Numeric(precision=18, scale=9),
               existing_nullable=False)
    op.alter_column('signals', 'size',
               existing_type=sa.DOUBLE_PRECISION(precision=53),
               type_=sa.Numeric(precision=18, scale=9),
               existing_nullable=False)
    op.alter_column('signals', 'r',
               existing_type=sa.DOUBLE_PRECISION(precision=53),
               type_=sa.Numeric(precision=18, scale=9),
               existing_nullable=False)
