from sqlalchemy import Column, Integer, String, Float, Boolean, BigInteger, Text, JSON, Index, Numeric
...
class Signal(Base):
    ...
    __table_args__ = (
        Index("idx_signals_lookup", "instrument_id", "status", "ts"),
    )
...
class Trade(Base):
    ...
    __table_args__ = (
        Index("idx_trades_instrument_ts", "instrument_id", "ts"),
    )
