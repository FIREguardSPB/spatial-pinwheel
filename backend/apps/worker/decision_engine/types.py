...
class ReasonCode(str, Enum):
    ...
    # Economic viability / micro-level guards
    ECONOMIC_INVALID = "ECONOMIC_INVALID"
    ECONOMIC_LOW_PRICE = "ECONOMIC_LOW_PRICE"
    ECONOMIC_MICRO_LEVELS = "ECONOMIC_MICRO_LEVELS"
    ECONOMIC_PROFIT_TOO_SMALL = "ECONOMIC_PROFIT_TOO_SMALL"
    ECONOMIC_MIN_TRADE_VALUE = "ECONOMIC_MIN_TRADE_VALUE"
    ECONOMIC_COMMISSION_DOMINANCE = "ECONOMIC_COMMISSION_DOMINANCE"
